...
namespace XHFrameWork
{
	...
	IMoveHandler  
	{
		...
		static public EventTriggerListener Get(GameObject go)  
		{
		    ...
		    //			return listener;\
		    EventTriggerListener temp = go.GetOrAddComponent<EventTriggerListener>();
		...
		public EventTriggerListener SetEventHandle(EnumTouchEventType _type, OnTouchEventHandle _handle, params object[] _params)
		{
			switch(_type)
			{
        ...
        internal void SetEventHandle(EnumTouchEventType onClick, GameObject startKK01Button)
        {
