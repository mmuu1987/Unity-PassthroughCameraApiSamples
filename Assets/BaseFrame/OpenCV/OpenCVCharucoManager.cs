...
{
    public class OpenCVCharucoManager : MonoBehaviour
    {


        public static OpenCVCharucoManager Instance;
        ...
        private void Awake()
        {
            ...
            OpenCvAnchor = _arObject.GetComponent<OpenCVAnchor>();
            ...
            m_charucoMarkerTracking.SetOpencvAnchor(_arObject);
        ...
        private IEnumerator Start()
        {
            ...
            if (m_webCamTextureManager == null)
            {
                Debug.LogError($"PCA: {nameof(m_webCamTextureManager)} field is required " +
                            $"for the component {nameof(OpenCVCharucoManager)} to operate properly");
                enabled = false;
                yield break;
            }
