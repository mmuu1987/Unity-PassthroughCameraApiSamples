...
public class Anchor : MonoBehaviour
{
    ...
    /// 锚点成功保存到持久存储卡中的事件
    /// </summary>
    public event Action<string, Anchor> OnSaveEvent;

    /// <summary>
    /// 抹去锚点成功的事件
    /// </summary>
    public event Action<Anchor> OnEaseEvent;

    public string UUID => _spatialAnchor.Uuid.ToString();
    ...
    public void OnSaveLocalButtonPressed()
    {
        ...
        _spatialAnchor.SaveAnchorAsync().ContinueWith((result, anchor) =>
        {
            ...
            {
                anchor.OnSave();
                OnSaveEvent?.Invoke(_spatialAnchor.Uuid.ToString(),this);
            }
            else
            {
    ...
    public bool IsLocaltied()
    {
        return _spatialAnchor.Localized;
    }
